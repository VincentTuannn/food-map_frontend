...
const VI: Dict = {
  ...
  'tourist.start.openMap': 'Mở Map',
  'tourist.start.tourSavedTitle': 'Đã lưu tour',
  'tourist.start.tourSavedDesc': 'Bạn có thể mở Map để xem POI.',
  'tourist.start.qrDemoTitle': 'Quét QR',
  'tourist.start.qrDemoDesc': 'Tích hợp camera sau.',
  ...
  'tourist.poi.viewMenuDemoTitle': 'Xem menu',
  ...
  'tourist.poi.navigateDemoTitle': 'Điều hướng',
  ...
  'tourist.poi.writeReviewDemo': 'Viết review',
  'tourist.premium.title': 'Premium',
  'tourist.premium.subtitle': '',
  'tourist.premium.paymentMock': 'Thanh toán',
  'tourist.premium.buyNow': 'Mua ngay',
  'tourist.premium.restore': 'Khôi phục',
  'tourist.premium.payDemo': 'Thanh toán',
  'tourist.premium.restoreDemo': 'Khôi phục giao dịch',
...
const EN: Dict = {
  ...
  'tourist.start.openMap': 'Open map',
  'tourist.start.tourSavedTitle': 'Tour saved',
  'tourist.start.tourSavedDesc': 'You can now open the Map to see POIs.',
  'tourist.start.qrDemoTitle': 'Scan QR',
  'tourist.start.qrDemoDesc': 'Integrate back camera.',
  ...
  'tourist.poi.viewMenuDemoTitle': 'View menu',
  ...
  'tourist.poi.navigateDemoTitle': 'Navigate',
